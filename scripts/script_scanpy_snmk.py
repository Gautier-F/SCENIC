...
#f_pyscenic_output = "../loomfiles/pyscenic_output.loom"
...
fig.savefig('../res/fig/filtering_panel_prefilter.pdf', dpi=600, bbox_inches='tight')
...
fig.savefig('../res/fig/filtering_panel_postfilter.pdf', dpi=600, bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('../res/fig/genes_cells_percentiles.pdf', dpi=600, bbox_inches='tight')
